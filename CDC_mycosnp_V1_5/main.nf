...
params.schema_ignore_params = "TMPDIR,schema_json,project_dirs,modules_json,input_samples,input_csv,vcfs,genomes,vcftools_filter,singularity_pull_docker_container"
params.fasta = WorkflowMain.getGenomeAttribute(params, 'fasta')
params.input = null
params.add_sra_file = false
params.add_vcf_file = false
params.genome = null
...
params.outdir = workflow.launchDir + '/out/Results'
...
params.coverage = 70
//params.rate = 0
params.gvcfs_filter = 'QD < 2.0 || FS > 60.0 || MQ < 40.0 || DP < 10'
params.vcftools_filter = '--min_GQ "50" --keep_GQ_0_refs --min_percent_alt_in_AD "0.8" --min_total_DP "10" --keep_all_ref'
...
params.snpeffconfig               = "$projectDir/assets/snpeffdb/snpEff.config"
params.species                    = 'candida_auris_gca_016772135.1'
params.genes                      = 'CAB11_002014'
params.positions                  = 'fks1_hs1=221638:221665,fks1_hs2=223782:223805'
params.exclude                    = 'synonymous_variant'
params.snpeff                     = true
